...
\def\temaatratar {Modelamiento, Implementación y Control de Micro-redes DC}

\def\autordeldocumento {Cristóbal y Felipe.}
...
\begin{tabular}{ll}
	...
	\multicolumn{2}{l}{Fecha de entrega: 9 de Octubre 2024} \\
