...
\usepackage{xspace}        % Adminsitra espacios en párrafos y 
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={7.0.0},
		Template.Version.Hash={CA4AC6D29009A3C32A1AAE9C0476875F},
		Template.Version.Release={7.0.0},
	...
	pdfproducer={Template-Informe v7.0.0 | (Pablo Pizarro R.) ppizarror.com},
